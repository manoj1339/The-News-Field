...
<head>
    ...
    <title>The News Field | Privacy Policy</title>
        ...
        <section style='margin-top: 160px'>
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                    <h1 style="margin-bottom:30px;font-weight:bold;">Privacy Policy</h1>
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to The News Field.</p>
                            </li>
                        <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
                        <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
                    <li><strong>Website</strong> refers to The News Field, accessible from www.thenewsfield.com</li>        <li><strong>Service</strong> refers to the Website.</li>
                    ...
                    <ul>
                            <li>By visiting this page on our website: www.thenewsfield.com</li>
                        </ul>
                    </div>
                </div>
            </div>
